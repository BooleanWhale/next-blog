...
module.exports = __webpack_require__("qxxx");
...
const postsDirectory = Object(path__WEBPACK_IMPORTED_MODULE_0__["join"])(process.cwd(), 'posts');
...
const Blog = ({
  ...
  return __jsx("div", null, __jsx("ul", null, slugs.map(slug => {
    return __jsx("li", {
      key: slug
